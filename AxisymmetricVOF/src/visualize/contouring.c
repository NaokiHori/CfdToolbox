...
#include "./contouring/types.h"
#include "./contouring/edge.h"
#include "./contouring/arrow.h"
#include "./contouring/square.h"
...
int contouring_exec(
    ...
    const size_t * sizes,
    const double * const * const grids,
    const double * const * const field,
