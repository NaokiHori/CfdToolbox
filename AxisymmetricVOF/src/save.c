...
int save(
  ...
  write_npy_file(dir_name, "xf", 1, (size_t []){nx + 2}, "'<f8'", sizeof(double), domain->xf);
  write_npy_file(dir_name, "xc", 1, (size_t []){nx + 2}, "'<f8'", sizeof(double), domain->xc);
  write_npy_file(dir_name, "zf", 1, (size_t []){nz + 2}, "'<f8'", sizeof(double), domain->zf);
  write_npy_file(dir_name, "zc", 1, (size_t []){nz + 2}, "'<f8'", sizeof(double), domain->zc);
  write_npy_file(dir_name,  "ux", NDIMS, (size_t [NDIMS]){nx + 2, nz + 2}, "'<f8'", sizeof(double), &flow_field->ux[0][0]);
  write_npy_file(dir_name,  "uz", NDIMS, (size_t [NDIMS]){nx + 2, nz + 2}, "'<f8'", sizeof(double), &flow_field->uz[0][0]);
  write_npy_file(dir_name,   "p", NDIMS, (size_t [NDIMS]){nx + 2, nz + 2}, "'<f8'", sizeof(double), &flow_field->p[0][0]);
  write_npy_file(dir_name, "vof", NDIMS, (size_t [NDIMS]){nx + 2, nz + 2}, "'<f8'", sizeof(double), &interface_field->vof[0][0]);
abort:
