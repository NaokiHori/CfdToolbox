...
#pragma omp parallel for
  ...
  // solve linear systems in y
  {
    ...
    const double * const tridiagonal_solver_m = poisson_solver->tridiagonal_solver_m;
    ...
    if (0 != tridiagonal_solver_exec(
        tridiagonal_solver_plan,
        tridiagonal_solver_l,
        tridiagonal_solver_m,
        tridiagonal_solver_u,
        eigenvalues,
        buf0
    )) {
